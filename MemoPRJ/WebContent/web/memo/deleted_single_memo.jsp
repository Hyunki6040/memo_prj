	...
	function resize(obj) {
	  ...
	  obj.style.height = (12+obj.scrollHeight)+"px";
		...
		<!---start-header---->
			...
			<form action="/memo/memoRegProc.do" method="post">
			...
			<div class="single-page">
							<div class="single-page-artical">
								<div class="artical-content">
									...
									<li><button type="button" onclick="location.href='/memo/recover.do' ">복구</button>&nbsp;&nbsp;<button type="button" onclick="location.href='/memo/remove.do' ">삭제</button></li>
							         </c:forEach>
									</ul>
									</div>

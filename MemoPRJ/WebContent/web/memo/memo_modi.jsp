			...
			<div class="single-page">
							<div class="single-page-artical">
								<div class="artical-content">
									<form action="/memo/modify.do" method="post"><ul>
										<c:forEach var="result" items="${list}" varStatus="status">
			        					<li>
									<h3><textarea name="contents" class="autosize" rows="5" cols="150" onkeydown="resize(this)" onkeyup="resize(this)" onclick="resize(this)" id="contents" placeholder="메모..." required="" onKeypress="auto_size(this,this.size)">${result.contents}</textarea></h3>
									<input type="hidden" name="id" value=<%=id%>>
									<input type="hidden" name="memo_no" value=<%=memo_no%>>
									</li>
									<li><br/><br/><br/></li>
									<input type="text" name="new_label" placeholder="새로운 라벨.." value="${result.memo_class}">
									<select name="label">
									...
									<li><input type="submit" value="저장">&nbsp;&nbsp;<button type="button" onclick="location.href='/memo/delete.do' ">삭제</button></li>
							         </c:forEach>
									</ul>
									 </form>
									</div>

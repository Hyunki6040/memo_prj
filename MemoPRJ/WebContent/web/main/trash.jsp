						 	...
						 	<div class="form_content">
								<div class="menu_box_list">
									<ul>
										...
										<li><a href="/main/main.do"><span>휴지통</span></a></li>
										<div class="clear"> </div>
									</ul>
								</div>
			...
			<div class="wrap">
			 ...
			 <span><br/><br/><br/><br/><br/></span>
			      ...
			      <ul id="tiles">
			        ...
			        <li class="li_start" onclick="location.href='/memo/deleted_single_memo.do?memo_no=${result.memo_no}'">
			        	<div class="post-info">
			        		<div class="post-basic-info">
				        		<span class="memo"><a href="/memo/deleted_single_memo.do?memo_no=${result.memo_no}">${result.contents}</a></span>
				        		<span><h5>label. <a href="/memo/single_memo.do?memo_no=${result.memo_no}">${result.memo_class}</a></h5></span>
			        			<span><h5>deleted date. <a href="/memo/deleted_single_memo.do?memo_no=${result.memo_no}">${result.del_dt}</a></h5></span>
			        		</div>
			        			<div class="clear"> </div>
			        		</div>
					</li>

...
<% if("".equals(id) || "".equals(temp_id)){ %>
		<form action="<%=request.getContextPath()%>/member/loginProc.do" method="post">
			<div class="agile-field-txt">
				<label>
					<i class="fa fa-envelope" aria-hidden="true"></i> 비밀번호 </label>
				<input type="password" name="putpassword" placeholder="Enter your password " required="" id="myInput" />
			...
			<div class="w3ls-bot">
				...
				<div class="form-end">
					...
					<br/>
					<a href="/member/find_pw.do">비밀번호 찾기</a>
					<br/>
